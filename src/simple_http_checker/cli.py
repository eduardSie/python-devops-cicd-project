...
@click.option("--timeout", default=5, help="Maximum time in seconds to wait for each request. Defaults to 5.")
@click.option("--verbose", "-v", is_flag=True, help="If set, enables debug logging for more detailed output.")
